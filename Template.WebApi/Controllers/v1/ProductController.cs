...
using Template.Application.Features.Products.Commands.DeleteProductById;
using Template.Application.Features.Products.Commands.UpdateProduct;
using Template.Application.Features.Products.Queries.GetAllProducts;
using Template.Application.Features.Products.Queries.GetProductById;
using Template.Application.Filters;
using System;
